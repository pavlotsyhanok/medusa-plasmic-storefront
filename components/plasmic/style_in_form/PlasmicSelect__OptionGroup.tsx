...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: r5JDVTtt_YIB/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: CqAxAwhP2M1V/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__m7Bzu)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___73Xje)}
              />
            </React.Fragment>
          ),
          value: args.children
